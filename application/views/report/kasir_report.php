...
<section class="content">
  <div class="box">
    <div class="box-header">
      <h3 class="box-title">Data Report Penjualan</h3>
    </div>
          ...
          <tr>
            ...
            <td class="text-center" width="200px">
						<button id="detail" data-target="#modal-detail" data-toggle="modal" class="btn btn-default btn-xs"
																...
																data-time="<?=substr($data->kasir_created, 11, 5)?>"
																...
																data-kasirid="<?=$data->kasir_id?>"><i class="fa fa-eye">Detail</i></button>
              <a href="<?= site_url('kasir/cetak/'.$data->kasir_id); ?>" target="_blank" class="btn btn-success btn-xs ">
                <i class="fa fa-print"> Cetak</i>
              </a>
              <a href="<?= site_url('kasir/del/'.$data->kasir_id); ?>" onclick="return confirm('Apakah Data Ini Ingin Dihapus ?')" class="btn btn-danger btn-xs ">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Kasir Report Detail</h4>
            </div>
...
$(document).on('click', '#detail', function() {
    ...
    $.getJSON('<?=site_url('report/kasir_produk/')?>'+$(this).data('kasirid'), function(data) {
